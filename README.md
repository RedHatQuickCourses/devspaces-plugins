...
This course is the fifth in a series of 5 courses about Red Hat OpenShift Dev Spaces. This course covers how to enable and configure plugins and extensions in Red Hat OpenShift Dev Spaces.
...
```
    $ git clone git@github.com:RedHatQuickCourses/devspaces-plugins.git
```

2. Install the npm dependencies for the course tooling.
```
    $ cd devspaces-plugins
    $ npm install
```
...
12. Verify that your changes have been published to the production GitHub pages website at https://redhatquickcourses.github.io/devspaces-plugins

# Problems and Feedback
If you run into any issues, report bugs/suggestions/improvements about this course here - https://github.com/RedHatQuickCourses/devspaces-plugins/issues